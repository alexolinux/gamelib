...
const App = () => {
  ...
  const [stats, setStats] = useState({ total: 0, played: 0 });
  ...
  return (
    ...
    >
      <header className="p-6 bg-slate-900/70 backdrop-blur-sm border-b border-slate-800 shadow-lg flex flex-col sm:flex-row justify-between items-center gap-4 z-10">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-violet-400 via-pink-400 to-yellow-400 bg-clip-text text-transparent drop-shadow-md animate-pulse">
            GameLib
          </span>
        </div>
        <div className="flex flex-wrap justify-center gap-3 sm:space-x-4">
          <button
            ...
            className={`${newButtonStyle} whitespace-nowrap`}
          >
            Add Console
          </button>
          <button
